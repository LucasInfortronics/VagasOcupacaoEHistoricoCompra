...
function init_daterangepicker_reservationDetectado() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservationDetectado"), $("#reservation").daterangepicker(null, function (a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
    }), $("#reservation-time-filtro").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
        locale: {
            format: "DD/MM/YYYY h:mm A",
